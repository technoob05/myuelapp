...
class AnalyticsProvider with ChangeNotifier {
  ...
  final List<Map<String, dynamic>> _chartData = [
    {'day': 'T2', 'value': 30.0, 'active': false},
    {'day': 'T3', 'value': 45.0, 'active': false},
    {'day': 'T4', 'value': 20.0, 'active': false},
    {'day': 'T5', 'value': 80.0, 'active': true},
    {'day': 'T6', 'value': 40.0, 'active': false},
    {'day': 'T7', 'value': 60.0, 'active': false},
    {'day': 'CN', 'value': 10.0, 'active': false},
  ];
